...
public class Test32 {
  ...
  public static void main(String[] args) {
    ...
    // 내가 추가한 test case
    System.out.println(tennisSet(6, 7));
    System.out.println(tennisSet(5, 7));
    System.out.println(tennisSet(8, 7));

  }

  static boolean tennisSet(int score1, int score2) {
    if ((score1 == 6 && score2 <= 4)||(score1 <= 4 && score2 == 6)) {
      return true;
    }

    if ((Math.min(score1, score2) >=5) && (Math.abs(score1 - score2) == 2)) {
      return true;
    }
    return false;
  }
