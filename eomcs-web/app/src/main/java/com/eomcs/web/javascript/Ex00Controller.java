...
public class Ex00Controller {
  ...
  public Object exam08() {
    Board[] boards = new Board[] {
        ...
        new Board(2, "제목2", Date.valueOf("2022-10-27"), 200),
        new Board(3, "제목3", Date.valueOf("2022-10-28"), 110),
        new Board(4, "제목4", Date.valueOf("2022-10-27"), 300),
        new Board(5, "제목5", Date.valueOf("2022-10-27"), 100),
        new Board(6, "제목6", Date.valueOf("2022-10-27"), 100)
    };
