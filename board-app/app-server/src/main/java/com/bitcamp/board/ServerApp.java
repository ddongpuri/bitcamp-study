  ...
  public static void main(String[] args) {
    ...
    try (
      ...
      try(
          ...
          // => 데이터를 읽을 때 primitive type 또는 String type의 값을
          //    보다 손쉽게 읽을 수 있도록, 기존의 입력 도구에 보조 도구(데코레이터)를 붙여 사용한다.
          DataInputStream in = new DataInputStream(socket.getInputStream());

          // => 클라이언트로 데이터를 보낼 때 사용할 도구를 준비한다. 

          // => 데이터를 출력할 때 primitive type 또는 String type의 값을
          //    보다 손쉽게 출력 할 수 있도록 기존의 출력 도구에 보조 도구(decorator)를 붙여 사용한다. 
